	...
	case loginDBCachePacketTypeLoginRequest: {
		...
		if (flag == true) {
			...
			if (packetLoginRequest.userId == "admin1" && packetLoginRequest.userPw == "12341234") {
				...
				packetLoginResponse.userNick = "1老1老";
				...
				packetLoginResponse.flag = true;
				packetLoginResponse.userNick = "2捞2捞";
				packetLoginResponse.gpid = 1;
				packetLoginResponse.userId = packetLoginRequest.userId;
				bufInfo->Clear();
				bufInfo->buffer = packetLoginResponse.Serialize();
				...
				packetLoginResponse.flag = true;
				packetLoginResponse.userNick = "3伙3伙";
				packetLoginResponse.gpid = 1;
				packetLoginResponse.userId = packetLoginRequest.userId;
				bufInfo->Clear();
				bufInfo->buffer = packetLoginResponse.Serialize();
				...
				packetLoginResponse.flag = true;
				packetLoginResponse.userNick = "4荤4荤";
				packetLoginResponse.gpid = 1;
				packetLoginResponse.userId = packetLoginRequest.userId;
				bufInfo->Clear();
				bufInfo->buffer = packetLoginResponse.Serialize();
				...
				packetLoginResponse.flag = true;
				packetLoginResponse.userNick = "5坷5坷";
				packetLoginResponse.gpid = 1;
				packetLoginResponse.userId = packetLoginRequest.userId;
				bufInfo->Clear();
				bufInfo->buffer = packetLoginResponse.Serialize();
				...
				packetLoginResponse.flag = true;
				packetLoginResponse.userNick = "6腊6腊";
				packetLoginResponse.gpid = 1;
				packetLoginResponse.userId = packetLoginRequest.userId;
				bufInfo->Clear();
				bufInfo->buffer = packetLoginResponse.Serialize();
